...
9. [Cài đặt VMware Exporter monitor vmware esxi](./docs/21._Cai_dat_VMware_exporter.md)
...
1. [Kiến trúc Thanos](./docs/19._Thanos_Architecture.md)
2. [Cài đặt Thanos để HA cho Prometheus](./docs/20._Trien_khai_HA_cho_prometheus_su_dung_thanos.md)
