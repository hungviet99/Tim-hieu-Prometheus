...
docker run --restart=always -d --name telegram-bot \
  ...
  -e "username=hungnv" \
  -e "password=123456" \
  -p 9119:9119 hungnv1008/alertmanager-webhook-telegram
```
...
CONTAINER ID   IMAGE                                        COMMAND      CREATED       STATUS       PORTS                                       NAMES
cf4c958fa7e4   hungnv1008/alertmanager-webhook-telegram   "./run.sh"   2 hours ago   Up 2 hours   0.0.0.0:9119->9119/tcp, :::9119->9119/tcp   telegram-bot
```
